...
TABLE_WIDTH_RATIO = 0.47  # ещё уже по ширине (~-10% от 0.52), обрезка фона привязана к таблице
MARGIN = 26  # + ~10% вертикальный отступ
ROW_HEIGHT = 26
HEADER_HEIGHT = 32
TITLE_HEIGHT = 38
FONT_SIZE_TITLE = 22
...
H_CROP_MARGIN = 28
# Таблица яркая, но фон чуть сильнее просвечивает (чуть более прозрачная)
COLOR_HEADER_BG = (70, 70, 70, 170)
COLOR_HEADER_TEXT = (255, 255, 255)
COLOR_ROW_BG = (255, 255, 255, 180)  # белый фон строк, прозрачность чуть выше (фон лучше виден)
COLOR_ROW_ALT = (248, 248, 248, 180)  # лёгкая зебра
COLOR_BREAK_BG = (235, 235, 235, 180)  # перерыв чуть серее
